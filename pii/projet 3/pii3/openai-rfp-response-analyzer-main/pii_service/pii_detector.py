...
class PIIDetector:
    """Main PII detection class that wraps the MultilingualPIIDetector functionality."""
    
    def __init__(self):
        self.detector = MultilingualPIIDetector()
    
    def detect_pii(self, text: str, language: str = 'en') -> Dict:
        """
        ...
        Returns:
            Dict: Detection results including entities and anonymized text
        """
        return self.detector.detect_and_anonymize(text, language)
    
    def batch_detect_pii(self, texts: List[str], language: str = 'en') -> List[Dict]:
        """
        ...
        """
        return self.detector.batch_detect_and_anonymize(texts, language)
    ...
    def get_supported_entities(self) -> List[str]:
        ...
        return self.detector.supported_entities